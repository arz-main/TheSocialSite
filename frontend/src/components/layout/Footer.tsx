	...
	return (
		<footer className="w-full bg-gray-800 text-white">
			<div className="flex justify-center space-x-6 py-2">
				...
				<Link to={Paths.artist.practice} className="hover:underline text-xs text-gray-300">Practice</Link>
				<Link to={Paths.explore} className="hover:underline text-xs text-gray-300">Explore</Link>
				<Link to={Paths.artist.statistics} className="hover:underline text-xs text-gray-300">Stats</Link>
