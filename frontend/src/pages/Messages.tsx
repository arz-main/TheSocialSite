...
import { formatRelativeTime, formatMessageTimestamp } from "../utils/messageUtils";
import type { ChatMessage, ChatViewProps, Conversation, ConversationItemProps } from "../types/messageTypes";
...
export default function MessagesPage() {
	...
	return (
		<section className="mx-screen w-full p-6 bg-background">
			...
			>
				<h1 className="text-text text-3xl font-bold mb-8">Messages</h1>
